            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 md:gap-16 mb-12 md:mb-24">
                    <div className="space-y-8">
                        ...
                        <p className="text-gray-500 text-[15px] leading-relaxed max-w-xs font-medium">
                            {dictionary.footer.desc}
                        </p>
                        <div className="flex space-x-4">
                            <a href="https://www.instagram.com/webfine.com.tr/" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center text-gray-400 hover:text-brand-primary hover:border-brand-primary/30 transition-all"><Instagram className="w-5 h-5" /></a>
                            <a href="https://wa.me/905515215958" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center text-gray-400 hover:text-green-500 hover:border-green-500/30 transition-all"><MessageCircle className="w-5 h-5" /></a>
                            <a href="tel:05515215958" className="w-12 h-12 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center text-gray-400 hover:text-brand-primary hover:border-brand-primary/30 transition-all"><Phone className="w-5 h-5" /></a>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-6">
                            <li><Link href={`/${lang}/legal/cookies`} className="text-gray-500 hover:text-white transition-colors text-sm font-bold">{dictionary.footer.legal.cookies}</Link></li>
                            <li><Link href={`/${lang}/legal/kvkk`} className="text-gray-500 hover:text-white transition-colors text-sm font-bold">{dictionary.footer.legal.kvkk}</Link></li>
                            <li><Link href={`/${lang}/legal/privacy`} className="text-gray-500 hover:text-white transition-colors text-sm font-bold">{dictionary.footer.legal.privacy}</Link></li>
                        </ul>
                    </div>
                </div>
