                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 md:gap-16 mb-12 md:mb-24">
                    ...
                    <div>
                        ...
                        <ul className="space-y-6">
                            ...
                            <li><Link href={`/${lang}/ucretsiz-seo-analizi`} className="text-brand-primary hover:text-white transition-colors text-sm font-black flex items-center group">{dictionary.nav.seoAnalysis}</Link></li>
